...
I'll repeat the default option below, but you can take either 2016, 2022, or both as the extracts to fetch. It returns a dataframe, and read in both extracts and concatenate into one:
